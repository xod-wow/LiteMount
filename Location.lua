...
local InstanceNotFlyable = {
    ...
    [0000] = true,          -- Island Expedition Molten Cay
    [0000] = true,          -- Island Expedition Rotting Mire
    [0000] = true,          -- Island Expedition Verdant Wilds
    [0000] = true,          -- Island Expedition Whispering Reef
}
