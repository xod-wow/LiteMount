...
LM_ITEM_MOUNT_ITEMS = {
--  LM_ITEM_LOANED_GRYPHON_REINS,
--  LM_ITEM_LOANED_WIND_RIDER_REINS,
    LM_ITEM_FLYING_BROOM,
    LM_ITEM_MAGIC_BROOM,
    LM_ITEM_DRAGONWRATH_TARECGOSAS_REST,
}

LM_ITEM_MOUNT_SPELLS = {
--  LM_SPELL_LOANED_GRYPHON,
--  LM_SPELL_LOANED_WIND_RIDER,
    LM_SPELL_FLYING_BROOM,
    LM_SPELL_MAGIC_BROOM,
    LM_SPELL_TARECGOSAS_VISAGE,
}
...
LM_FlagOverrideTable = {
    ...
    [LM_SPELL_FLYING_BROOM]       = bit.bor(LM_FLAG_BIT_WALK,
                                            LM_FLAG_BIT_FLY),
