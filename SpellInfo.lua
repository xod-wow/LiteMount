...
LM_ITEM_RIVER_BOAT = 55121

LM_SPELL_SLOW_FALL = 130
LM_SPELL_LEVITATE = 1706
...
LM_ITEM_MOUNT_ITEMS = {
    ...
    [LM_ITEM_RIVER_BOAT] = LM_SPELL_RIVER_BOAT,
}

LM_HELP_IM_FALLING_SPELLS = {
    LM_SPELL_LEVITATE,
    LM_SPELL_SLOW_FALL,
}
