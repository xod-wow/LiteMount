...
-- enUS / enGB / Default -------------------------------------------------------
    ...
    L["LM_SUMMON_CHAT_MESSAGE"] = "Summon: %s (Priority: %d, Count: %d)"
...
if locale == "deDE" then
    ...
    L["LM_SUMMON_CHAT_MESSAGE"] = "Beschwören: %s (Priorität: %d, Zählung: %d)"
...
if locale == "esES" or locale == "esMX" then
    ...
    L["LM_SUMMON_CHAT_MESSAGE"] = "Invocar: %s (Prioridad: %d, Cuenta: %d)"
...
if locale == "frFR" then
    ...
    L["LM_SUMMON_CHAT_MESSAGE"] = "Invoquer: %s (Priorité: %d, Compte: %d)"
...
if locale == "itIT" then
    ...
    L["LM_SUMMON_CHAT_MESSAGE"] = "Evoca: %s (Priorità: %d, Conte: %d)"
...
if locale == "koKR" then
    ...
    L["LM_SUMMON_CHAT_MESSAGE"] = "소환: %s (우선 순위: %d, 횟수: %d)"
    L["LM_TRANSLATORS"] = "번역"
    L["LM_USABLE"] = "사용 가능한"
...
if locale == "ptBR" then
    ...
    L["LM_SUMMON_CHAT_MESSAGE"] = "Evocar: %s (Prioridade: %d, Contagem: %d)"
...
if locale == "ruRU" then
    ...
    L["LM_SUMMON_CHAT_MESSAGE"] = "Призвать: %s (Приоритет: %d, Количество: %d)"
...
if locale == "zhCN" then
    ...
    L["LM_SUMMON_CHAT_MESSAGE"] = "优先: %s (召唤: %d, 计数: %d)"
    L["LM_TRANSLATORS"] = "译者"
    L["LM_USABLE"] = "可用"
...
if locale == "zhTW" then
    ...
    L["LM_SUMMON_CHAT_MESSAGE"] = "召喚: %s (優先: %d, 計數: %d)"
    L["LM_TRANSLATORS"] = "譯者"
    L["LM_USABLE"] = "可用"
