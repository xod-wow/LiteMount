...
-- enUS / enGB / Default -------------------------------------------------------
    ...
    L["LM_PRECAST_DESCRIPTION"] = "Register a spell to try to cast before mounting. Enter a spell name or spell ID. Only works before journal mounts, and the spell must have no cast time."
    L["LM_PREUSE_ACTION"] = "Set Up Pre-use Item"
    L["LM_PREUSE_DESCRIPTION"] = "Register an item to try use before mounting. Enter an item name, item ID or equipment slot number. Only works before journal mounts. The item should have no cast time."
