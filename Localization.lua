...
-- enUS / enGB / Default -------------------------------------------------------
    ...
    L["LM_COPY_JOURNAL_FAVORITES"] = "Copy journal favorites"
    L["LM_COPY_JOURNAL_FAVORITES_DESC"] = "Sets the priority of all mounts currently set as favorite in the journal to 1, and 0 for the others (only affects mounts with priority 0 or 1)"
    L["LM_COPY_JOURNAL_FAVORITES_DIALOG"] = "This cannot be undone, are you sure?"
...
if locale == "frFR" then
    ...
    L["LM_COPY_JOURNAL_FAVORITES"] = "Copier favorites du journal"
    L["LM_COPY_JOURNAL_FAVORITES_DESC"] = "Change la priorité de toutes les montures actuellement comptées comme favorites dans le journal à 1, 0 pour les autres (n'affecte que les mountures du journal ayant une priorité de 0 ou 1)"
    L["LM_COPY_JOURNAL_FAVORITES_DIALOG"] = "Cette action n'est pas réversible, êtes-vous sûr(e)?"
