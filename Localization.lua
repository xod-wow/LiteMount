...
if locale == "deDE" then
    ...
    L["LM_PRIORITYMOUNT_DESCRIPTION"] = [=[Beschwöre ein zufälliges Reittier.
    Beachtet die Priorität/Seltenheit, um Reittiere häufiger, seltener oder nie zu beschwören.]=]
    ...
    L["LM_SMARTMOUNT_DESCRIPTION"] = [=[Beschwöre ein zufälliges Reittier, welches für die aktuelle Situation am besten ist.
    Beachtet die Priorität/Seltenheit, um Reittiere häufiger, seltener oder nie zu beschwören.]=]
