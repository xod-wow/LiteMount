...
if locale == "koKR" then
    ...
    L["LM_MOUNT_DESCRIPTION"] = "랜덤으로 탈것 소환하기"
    ...
    L["LM_SMARTMOUNT_DESCRIPTION"] = "현재 상황에 따라 가장 적합한 유형의 탈것을 랜덤으로 소환합니다. 탈것의 우선순위/희귀성에 따라 소환하는 경우가 많거나 적습니다 (또는 그렇지 않을 수도 있습니다)."
