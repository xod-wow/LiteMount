...
if locale == "koKR" then
L.FLY                   = "비행"
L.LM_ADVANCED_EXP       = "이 설정을 통해 각각의 LiteMount 단축키로 실행할 행동을 개별 설정할 수 있습니다. 변경 전 아래 URL의 설명서를 읽어보십시오."
L.LM_AUTHOR             = "제작자"
...
L.LM_EXPORT_PROFILE_EXP = "아래 문자열을 복사하여 파일로 저장해두었다가 '프로필 불러오기'를 통해 복구할 수 있습니다."
L.LM_FAMILY             = "유형"
L.LM_FLAGS              = "속성"
...
L.LM_REPORT_BUG_EXP     = "LiteMount의 버그를 신고하려면, 경험한 내용을 상단에 적어주세요. (각각의 질의에 맞게 영어로) 그런 다음, 적은 내용을 포함하여 아래 문자열 전체를 하단 URL주소에 남겨주세요."
