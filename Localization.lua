...
L.LM_ACTION_LISTS       = "Action Lists"
L.LM_AUTHOR             = "Author"
...
L.LM_FLAGS              = "Flags"
L.LM_FLAGS_EXP          = "After creating flags here, you can assign them to mounts using the %s tab. You can then use them in action lists to customize LiteMount's behaviour."
